 ...
 */
export function zcodePersonalProviderPath() {
 ...
 */
export function zcodeAgentsDir() {
 ...
 */
export function clientConnectionRoot(client) {
    return client?.connectionContext;
}
/**
