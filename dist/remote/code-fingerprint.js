...
export function codeFingerprintPath(distDir) {
    return distDir
...
export function readCodeFingerprint(distDir) {
    try {
        const parsed = JSON.parse(readFileSync(codeFingerprintPath(distDir), "utf8"));
...
//# sourceMappingURL=code-fingerprint.js.map