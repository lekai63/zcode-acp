...
export function goalMaxTurns(env = process.env) {
...
export function goalModeIsBackend(env = process.env) {
...
export function initialSessionMode(env = process.env) {
 ...
 */
export function interactionTimeoutMs(env = process.env) {
...
export function globalSandboxEnabled(env = process.env) {
 ...
 */
export function tuiStatsSegments(env = process.env) {
 ...
 */
export function languageOverride(env = process.env) {
    const pick = (v) => {
